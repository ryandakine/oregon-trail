// Vendored verbatim from KAPLAY's example gallery,
// examples/shaders/vhs.frag @ kaplayjs/kaplay master.
//
// MIT License. Copyright (c) 2025 KAPLAY Team.
// https://github.com/kaplayjs/kaplay/blob/master/LICENSE
//
// Source unit only: the composed pass in horror.frag is what actually runs,
// because usePostEffect() holds a single shader slot. Kept unmodified so the
// derived YIQ chroma-bleed block there stays diffable against upstream.
